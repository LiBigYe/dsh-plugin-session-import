    ...
    function ImportDialog({ onClose }) {
      ...
      const loadSessions = useCallback(async (t, startOffset, q) => {
        ...
        try {
          ...
          if (mySeq !== reqSeq.current) return // 过期响应丢弃（快速切换工具）
      ...
      // 搜索防抖：停止输入 300ms 后重新加载（首次挂载立即加载）
      ...
      useEffect(() => {
        ...
        const timer = setTimeout(() => { loadSessions(tool, 0, query); }, 300);
      ...
      return React.createElement("div", { style: style.dialog },
        ...
        React.createElement("div", { style: { position: "relative", marginTop: "2px" } },
          ...
          React.createElement("span", { style: {
            ...
            color: colors.dimmer, fontSize: "13px", cursor: query ? "pointer" : "default",
          }, onClick: () => { if (query) setQuery(""); } }, query ? "✕" : "🔍")),

        React.createElement("div", { ref: listRef, style: style.list, onScroll: (e) => {
          ...
          !loading && sessions !== null && sessions.length > 0 && [
            ...
            sessions.map((s) => React.createElement("div", {
              ...
              React.createElement("div", { style: { flex: "1", minWidth: "0" } },
                ...
                React.createElement("div", { style: { color: colors.dimmer, fontSize: "10.5px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } },
                  (s.project ? s.project + " · " : "") + fmtTime(s.updatedAt))),
